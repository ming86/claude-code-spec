...
**Project Description**: ${input:description:Enter detailed project description}
...
- Structure context: [structure.md](../../.spec-workflow/steering/structure.md)
...
Use `search` tool to check if `.spec-workflow/steering/` directory exists.
...
**NEXT STEP**: Use /spec-2-requirements: feature={feature-name} to generate detailed requirements
```
...
1. **Generate requirements**: /spec-2-requirements: feature={feature-name}
2. **Review and approve requirements**: Update spec.yaml
3. **Generate design**: /spec-3-design: feature={feature-name} (after requirements approval)
4. **Review and approve design**: Update spec.yaml
5. **Generate tasks**: /spec-4-tasks: feature={feature-name} (after design approval)
6. **Review and approve tasks**: Update spec.yaml
