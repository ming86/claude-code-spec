---
description: Create custom project steering documents for specialized contexts
mode: agent
...
- **Usage**: Reference with [filename](path) during specific conversations
...
2. **Create the document** in `.spec-workflow/steering/` with:
