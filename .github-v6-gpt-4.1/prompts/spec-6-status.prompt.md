...
Provide comprehensive progress tracking and quality assessment for feature: **${input:feature:Enter feature name}** with accurate metrics, actionable insights, and clear recommendations.
